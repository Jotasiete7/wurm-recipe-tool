...
const DailyChallengeCard: React.FC<DailyChallengeCardProps> = ({ onChallenge, t }) => {
    return (
        <div
            onClick={onChallenge}
            className="group relative bg-black/20 rounded border border-wurm-accent/30 hover:border-wurm-accent hover:bg-wurm-accent/5 transition-all duration-300 cursor-pointer overflow-hidden shadow-lg shadow-black/50 h-[170px] flex flex-col items-center justify-center text-center p-6"
        >
